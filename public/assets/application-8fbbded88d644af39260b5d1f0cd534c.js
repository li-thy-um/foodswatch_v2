...
setDocument = Sizzle.setDocument = function( node ) {
	...
	support.getByClassName = assert(function( div ) {
		...
		div.innerHTML = '<div class='hidden e'><div class='hidden'>';
...
+function ($) {
  ...
  Tooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class='tooltip' role='tooltip'><div class='tooltip-arrow'><div class='tooltip-inner'>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
...
+function ($) {
  ...
  Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
    ...
    trigger: 'click',
    content: '',
    template: '<div class='popover' role='tooltip'><div class='arrow'><h3 class='popover-title'></h3><div class='popover-content'>'
  })
