...
(function() {
  ...
  $(function() {
    $('.micropost .panel-footer').each(function() {
      var $micropost, collapse, micropost_id;
      ...
      return $micropost.find('.btn-comment').data('collapse', collapse);
    });
    $(document).on('click', '.micropost .btn-share', function() {
      var collapse;
      collapse = $(this).data('collapse');
      return collapse && collapse.act('share');
    });
    return $(document).on('click', '.micropost .btn-comment', function() {
      var collapse;
      collapse = $(this).data('collapse');
      return collapse && collapse.act('comment');
    });
  });
